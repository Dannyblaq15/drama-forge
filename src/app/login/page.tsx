...
import { AlertCircle, Loader2, Globe, Mail, Lock } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleEmailSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Backend sync happens via a separate hook or effect on layout/dashboard
      router.push('/studio');
    } catch (err: any) {
      ...
      <div className="z-10 flex w-full max-w-md flex-col items-center">
        ...
        <Card className="w-full glass-panel border-neutral-800 shadow-2xl p-4 sm:p-8">
          <CardHeader className="space-y-2 text-center pb-8">
            <CardTitle className="text-3xl font-bold tracking-tight text-neutral-100">Welcome back</CardTitle>
